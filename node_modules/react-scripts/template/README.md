...
Open [https://beat-profile.herokuapp.com](https://beat-profile.herokuapp.com) to view it in the browser.
...
```json
{
  ...
  "configurations": [{
    ...
    "type": "chrome",
    "request": "launch",
    "url": "https://beat-profile.herokuapp.com",
